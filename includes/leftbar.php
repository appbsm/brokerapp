<div class="left-sidebar bg-black-300 box-shadow " style="background-color: #102958;">
    <div class="sidebar-content">
        
                            <div class="user-info closed">
                                <img src="http://placehold.it/90/c2c2c2?text=User" alt="John Doe" class="img-circle profile-img">
                                <h6 class="title"><?php echo "Role : ".$_SESSION['role_name']; ?></h6>
                                <small class="info"><?php echo "Name : ".$_SESSION['name']; ?></small>
                            </div>
                            <!-- /.user-info -->
                                ...
                                <ul class="side-nav color-gray">
                                   <!--  <li class="nav-header">
                                    ...
                                    <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Information</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="customer-information.php"><i class="fa fa-bars"></i> <span>Customer Information</span></a></li>
                                            <li><a href="manage-role.php"><i class="fa fa fa-server"></i> <span>Partner Information</span></a></li>
                                   ...
                                   <!--  <li class="nav-header">
                                    ...
                                    <!-- <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>User & Role Management</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="manage-user.php"><i class="fa fa-bars"></i> <span>User Management</span></a></li>
                                            <li><a href="manage-role.php"><i class="fa fa fa-server"></i> <span>User Role Management </span></a></li>
                                    ...
                                    <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="manage-product.php"><i class="fa fa-bars"></i> <span>Products Management </span></a></li>
                                            <li><a href="manage-role.php"><i class="fa fa fa-server"></i> <span>User Role Management </span></a></li>
