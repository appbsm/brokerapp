...
echo "<script>window.location.href ='period.php'</script>";
    ...
    $error="This period already exit";
}
...
if($_GET['id']){
    $sql_user = " SELECT * from period WHERE id=".$_GET['id'];
    ...
    <div class="row breadcrumb-div" style="background-color:#ffffff">
        <div class="col-md-6" >
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="period.php">Payment Term</a></li>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group row col-md-10 col-md-offset-1" >
                    ...
                    <div class="col ">
                         <input minlength="1" maxlength="50" style="border-color:#102958; color: #000;" type="text" required="required" class="form-control" name="period" id="period" value="<?php echo $period; ?>" >
                    </select>
                    </div> 
                    <div class="col ">
