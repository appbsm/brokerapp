<?php
	...
	$sql = "SELECT * from customer_level where level_name='".$level_name."'";   
	$query = $dbh->prepare($sql);
	$query->execute();
	...
	$sql="INSERT INTO  customer_level(level_name,description,status,cdate,create_by)
		 VALUES(:level_name_p,:description_p,:status_p,GETDATE(),:create_by_p)";
			...
			<div class="row breadcrumb-div" style="background-color:#ffffff">
				<div class="col-md-6" >
					<ul class="breadcrumb">
						...
						<li class="active">Add Customer Level</li>
					</ul>
				</div>
			</div>
		</div>
                    ...
                    <div class="form-group row col-md-10 col-md-offset-1">
                        <div class="col">
                            <div class="panel-title" style="color: #102958;" >
                                <h2 class="title">Add Customer Level</h2>
                            </div>
                        </div>
                        <div class="col-sm-2 ">
                        </div>
