    ...
    <div class="modal-dialog modal-lg" >
        <div class="modal-content">
            ...
            <div class="form-group row col-md-12">
                ...
                <div class="col-2">
                    <select id="period_popup" style="color: #0C1830;border-color:#102958;"class="form-control" >
            ...
            <div class="form-group row col-md-12">
                ...
                <div class="col-sm-2 " >
                    <input id="percent_trade_pop" type="text" class="form-control" style="border-color:#102958;"
                ...
                <div class="col-sm-2 " >
                    <input type="number" id="commission_pop" style="border-color:#102958;" class="form-control" value="<?php echo number_format((float)$commission_rate, 2, '.', ''); ?>" readOnly/>
                </div>
                 <div class="col-sm-2 " >
...
<script >
    function click_payment() {
        var period_type  = document.getElementById("period_popup").value;
        ...
        var calculate = document.getElementById("calculate_php").value;
        var commission = document.getElementById("commission_pop").value;
        var payment_status = document.getElementById("payment_status_pop").value;
        var paid_date = document.getElementById("paid_date_pop").value;

        if(value_premium=="" || value_percent=="" || value_start=="" || value_end=="" || calculate=="" || commission=="" || payment_status=="" || paid_date=="value_start"){
    ...
    function convertion_value_funtion(){
        var premium_rate_object = $('#premium_rate_pop');
        var convertion_value_object = $('#convertion_value');
        var currency_object = $('#currency');   
        var premium_value =document.getElementById("premium_rate_pop").value.replace(/,/g,'');
