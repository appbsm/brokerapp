                ...
                <div class="container-fluid">
							...
							<div class="card border-left-primary shadow h-100 py-2">
								<a href="entry-policy.php" style="text-decoration: none; color: inherit;">
									<div class="card-body">
										<div class="row">
											<div class="col mr-2">
												<div class="text-xs font-weight-bold text-primary text-uppercase mb-1" style="font-size: medium;">
													Total Policy (Monthly)</div>
							...
							<div class="card border-left-success shadow h-100 py-2">
								<a href="entry-policy.php" style="text-decoration: none; color: inherit;">
									<div class="card-body">
										<div class="row ">
											<div class="col mr-2">
												<div class="text-xs font-weight-bold text-success text-uppercase mb-1" style="font-size: medium;">
													Policy (New)</div>
												<div class="h5 mb-0 font-weight-bold text-gray-800 mt-4"><?php echo $num_policies; ?></div>
											</div>
											<div class="col-auto">
							...
							<div class="card border-left-info shadow h-100 py-2">
								<a href="entry-policy.php" style="text-decoration: none; color: inherit;">
									<div class="card-body">
										<div class="row ">
											<div class="col mr-2">
												<div class="text-xs font-weight-bold text-info text-uppercase mb-1" style="font-size: medium;">
													Policy (Renew)</div>
												<div class="h5 mb-0 font-weight-bold text-gray-800 mt-0"><?php echo $num_policies; ?></div>
											</div>
											<div class="col-auto">
							...
							<div class="card border-left-dark shadow h-100 py-2">
								<a href="entry-policy.php" style="text-decoration: none; color: inherit;">
									<div class="card-body">
										<div class="row ">
											<div class="col mr-2">
												<div class="text-xs font-weight-bold text-dark text-uppercase mb-1" style="font-size: medium;">
													Policy (Not Renew)</div>
												<div class="h5 mb-0 font-weight-bold text-gray-800 mt-0"><?php echo $num_policies; ?></div>
											</div>
											<div class="col-auto">
												<i class="fa fa-btc fa-2x text-gray-300"></i>
							...
							<div class="card border-left-warning-2 shadow h-100 py-2">
								<a href="entry-policy.php" style="text-decoration: none; color: inherit;">
									<div class="card-body">
										<div class="row">
											<div class="col mr-2">
												<div class="text-xs font-weight-bold text-warning-2 text-uppercase mb-1" style="font-size: medium;">
													Due Policy (Monthly)</div>
												<div class="h5 mb-0 font-weight-bold text-gray-800 mt-0"><?php echo $num_policies; ?></div>
											</div>
											<div class="col-auto">
												<i class="fas fa-calendar fa-2x text-gray-300"></i>
										...
										<div class="row mt-3">
											<div class="col">
												<div class="text-xs font-weight-bold text-warning-2 text-uppercase mb-1">
													Total Premium </div>
												<!--<div class="h5 mb-0 font-weight-bold text-gray-800">฿<?php //echo number_format($total_premium); ?></div>-->
												<div class="h5 mb-0 font-weight-bold text-gray-800 mt-0"><?php echo isset($total_premium) ? '฿' . number_format($total_premium, 0, '.', ',') : '฿0'; ?></div>
											</div>
							...
							<div class="card border-left-danger shadow h-100 py-2">
								<a href="entry-policy.php" style="text-decoration: none; color: inherit;">
									<div class="card-body">
										<div class="row ">
											<div class="col mr-2">
												<div class="text-xs font-weight-bold text-danger text-uppercase mb-1" style="font-size: medium;">
													Policy (Wait)</div>
												<div class="h5 mb-0 font-weight-bold text-gray-800 mt-0"><?php echo $num_policies; ?></div>
											</div>
											<div class="col-auto">
					...
					<div class="row">
						...
						<?php
							...
							$sql_count = "SELECT 
								COUNT(CASE WHEN pc.categorie = 'Life' THEN 1 END) AS life_count,
								COUNT(CASE WHEN pc.categorie = 'Non Life' THEN 1 END) AS non_life_count
							FROM 
								insurance_info i
							LEFT JOIN 
								product_categories pc ON pc.id = i.product_category
							WHERE 
								YEAR(i.paid_date) = YEAR(GETDATE());
							";
							$stmt_count = $dbh->prepare($sql_count);
							$stmt_count->execute();
							$result_count = $stmt_count->fetch(PDO::FETCH_ASSOC);

							$life_count = $result_count['life_count'];
							$non_life_count = $result_count['non_life_count'];

							$labels = array('Life', 'Non Life');
							$data = array($life_count, $non_life_count);
						?>
						...
						<div class="col-xl-12 col-lg-12">
							<div class="card shadow mb-4">
								<a href="report-customer-sales-total.php" style="text-decoration: none; color: inherit;">
									<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
										<h6 class="m-0 font-weight-bold text-primary">Sales by Customers</h6>
									</div>
								</a>
								<div class="card-body">
									<div class="chart-bar">
					...
					<div class="row">
						...
						<div class="col-xl-12 col-lg-12">
							<div class="card shadow mb-4">
								<a href="report-customer-sales-total.php" style="text-decoration: none; color: inherit;">
									<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
										<h6 class="m-0 font-weight-bold text-primary">Sales by Partners</h6>
									</div>
								</a>
								<div class="card-body">
									<div class="chart-bar">
							...
							var color;
								switch (product) {
									...
									case 'D&O':
										...
										break;
									default:
										color = '#000000'; // สีดีฟอลต์สำหรับกรณีที่ไม่มีข้อมูลสีที่ต้องการ
								}
