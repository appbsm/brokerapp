...
//             data: 'submit=update'
//         });
//         let el = document.getElementById("submitForm");
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="submit" value="update" class="btn bg-gradient-success">Submit</button>
