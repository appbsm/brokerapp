...
$sql ="SELECT cl.path_web,user_info.* 
 FROM user_info
...
<html lang="en">
    ...
    <body class="">
        ...
        <form class="form-horizontal" method="post">
            <div class="panel-body p-20" >
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="username" name="username" class="form-control" id="inputEmail3" placeholder="UserName"  >
                    </div>
                </div>
                <div class="form-group">
        ...
        <script>
            ...
            username_object.addEventListener("change", function() {
                document.getElementById("company").value = '';
                $.get('get_company_name.php?username=' + $(this).val(), function(data){
