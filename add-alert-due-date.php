    ...
    <div class="row breadcrumb-div" style="background-color:#ffffff">
        <div class="col-md-6" >
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="alert-due-date.php">View Alert Setting</a></li>
            ...
            <div class="panel-body">
                <div class="form-group row col-md-10 col-md-offset-1" >
                    <div class="col-sm-2  label_left" >
                        <label style="color: #102958;" for="success" class="control-label">Subject</label>
                    </div> 
                    <div class="col ">
                         <!-- <input minlength="1" maxlength="50" style="border-color:#102958;" type="text" name="subject" required="required" class="form-control" id="success" value="<?php //echo $subject; ?>" > -->
