...
$sql=$sql." VALUES(:customer_name_p,:customer_id_p,:title_name_p,:first_name_p,:last_name_p".
    ...
    if($lastInsertId_customer){ //// insert insurance
        ...
        for ($i=0;$i<count($_POST['policy']);$i++) {
            ...
            ",file_name_uniqid,default_insurance,calculate_type,payment_status,paid_date,cdate,create_by,reason)";
        $sql=$sql." VALUES (:insurance_company_p,:policy_no_p,:status_p,:product_category_p,:sub_categories_p".
                ...
                ",:file_name_uniqid_p,:default_insurance_p,:calculate_type_p,:payment_status_p,:paid_date_p,GETDATE(),:create_by_p,:reason_p)";
            $query = $dbh->prepare($sql); 
...
<div class="container-fluid">
        ...
        <div class="panel-body">
            ...
            <div class="form-group row mb-20 col-md-10 col-md-offset-1">
                <div class="col-sm-2 label_left" >
                    <label style="color: #102958;" for="staticEmail" ><small><font color="red">*</font></small>Product Category:</label>
                </div>
            <div class="col-sm-4">
            ...
            <div class="form-group row mb-20 col-md-10 col-md-offset-1">
                <div class="col-sm-2  label_left" >
                    <label style="color: #102958;" for="staticEmail" ><small><font color="red">*</font></small>Panel Company:</label>
                </div>
                <div class="col-sm-4"  >
            ...
            <div class="form-group row col-md-10 col-md-offset-1">
                ...
                <div class="col-sm-2">
                    <input type="text" id="currency" name="currency[]" style="border-color:#102958;" class="form-control"
            ...
            <div class="form-group row col-md-10 col-md-offset-1">
                ...
                <div class="col-sm-2">
                    <input id="end_date" name="end_date[]" style="color: #0C1830;border-color:#102958;" type="text"  class="form-control" 
      ...
      function addMonths(date, months) {
        ...
        return d;
            ...
            document.getElementById('percent_trade').value = parseFloat(document.getElementById('percent_trade').value).toFixed(2);
                ...
                <div class="col-sm-2">
                    <input id="paid_date" name="paid_date[]"  style="color: #0C1830;border-color:#102958;" type="test"  class="form-control" 
    ...
    // input.value = value;
        ...
        <div class="form-group row col-md-10 col-md-offset-1">
            ...
            <div class="col-sm-2 label_right" >
                ...
                <label style="color: #102958;" for="staticEmail"  ><small><font color="red">*</font></small>Upload Documents:</label>
            </div>
            <div class="col">
                <div >
                    <input name="file_d[]" id="imgInp" type="file" style="width: 100%;" accept="application/pdf" required>
                </div>
            </div>
        </div>
...
<div class="container-fluid">
    ...
    <div class="form-group row col-md-10 col-md-offset-1">
        ...
        <div class="col-sm-2 label_left" >
            <label style="color: #102958;" for="staticEmail" ><small><font color="red">*</font></small>Customer name:</label>
        </div>
                <div class="col-sm-4">
    ...
    <div class="form-group row col-md-10 col-md-offset-1">
        <div class="col-sm-2 label_left mb-20" >
            <label style="color: #102958;" for="staticEmail" ><small><font color="red">*</font></small>Customer Type:</label>
        </div>
    ...
    <div class="form-group row col-md-10 col-md-offset-1">
        <div class="col-sm-2 label_left" >
            <label style="color: #102958;" ><small><font color="red">*</font></small>Customer ID:</label>
        </div>
        <div class="col">
        ...
        <div class="col-sm-2 label_right">
            <label style="color: #102958;"  ><small><font color="red">*</font></small>Customer Level:</label>
        </div>   

            <div class="col">

                <select id="level_c_input" name="level_c_input" style="border-color:#102958;"   class="form-control" required>
                    <option value="0" selected>Select Customer Level</option>
                    <?php  foreach($results_c_level as $result){ ?>
                        <option value="<?php echo $result->id; ?>" ><?php echo $result->level_name; ?></option>
                    <? } ?>
                </select>
            </div>
    </div>
    ...
    <div class="form-group row col-md-10 col-md-offset-1">
            ...
            <div id="title_input" class="col-sm-4 personal"  >
            ...
            <div class="col-sm-2 label_left" id="company_c_label" hidden="true"  >
                    <label  style="color: #102958;" ><small><font color="red">*</font></small>Company name:</label>
            </div>
            <div class="col" id="company_input" hidden="true" >
        ...
        <div class="form-group row col-md-10 col-md-offset-1">
                ...
                <div id="first_input" class="col-sm-4 personal">
                ...
                <div id="last_c_label" class="col-sm-2 label_right personal" >
                    <label  style="color: #102958;" ><small><font color="red">*</font></small>Last name:</label>
                </div>
                <div id="last_input" class="col-sm-4 personal">
                    <input id="last_c_input" name="last_c_input" minlength="1" maxlength="50" style="color: #0C1830;border-color:#102958;" type="text" class="form-control"  required>
                </div>
        </div>
        ...
        <div class="form-group row col-md-10 col-md-offset-1">
                ...
                <div id="div_personal_e_per" class="col-sm-2 label_right" >
                    <label style="color: #102958;" ><small><font color="red">*</font></small>Email:</label>
                </div> 
                <div id="div_personal_e_cor" hidden="true" class="col-sm-2 label_left" >
                    <label style="color: #102958;" ><small><font color="red">*</font></small>Email:</label>
                </div> 
                <div class="col">
                    <input id="email_c_input" name="email_c_input" minlength="1" maxlength="50" style="color: #0C1830;border-color:#102958;" type="email"   class="form-control"  required>
                </div>

                <div id="div_r_email_label" class="col-sm-2" hidden="true" >
                </div>
                <div id="div_r_email_input" class="col" hidden="true" >
                </div>  

            </div>

        <div class="form-group row col-md-10 col-md-offset-1">
                <div id="div_personal" class="col-sm-2 label_right" >
                    <label style="color: #102958;" for="staticEmail" ><small><font color="red">*</font></small>Mobile1:</label>
                </div>
                <div id="div_corporate" hidden="true" class="col-sm-2 label_left" >
                    <label style="color: #102958;" for="staticEmail" ><small><font color="red">*</font></small>Mobile2:</label>
                </div>
                <div class="col">
                    <input id="mobile_c_input" name="mobile_c_input" minlength="10" maxlength="12" style="color: #0C1830;border-color:#102958;" type="text"   class="form-control"  required pattern="\d{3}-\d{3}-\d{4}">
                </div>
                <script>
                ...
                <div id="div_personal_tel_la" hidden="true" class="col-sm-2 label_right" >
                    <label style="color: #102958;" >Tel2:</label>
                </div>
        ...
        <div id="div_personal_tel" class="form-group row col-md-10 col-md-offset-1">
                 ...
                 <div  class="col-sm-2 label_right" >
                    <label style="color: #102958;" for="staticEmail" >Tel1:</label>
                </div>
                <div class="col">
...
<div class="container-fluid">
        ...
        <div class="panel-body">
            <div class="form-group row mb-20 col-md-10 col-md-offset-1">
                ...
                <div class="col-sm-2 label_left" >
                    <label style="color: #102958;" for="staticEmail" ><small><font color="red">*</font></small>Title Name:</label>
                </div>
                <div  class="col">
            ...
            <div class="form-group row col-md-10 col-md-offset-1">
                ...
                <div class="col-sm-2 label_right" >
                    <label style="color: #102958;" ><small><font color="red">*</font></small>Mobile:</label>
                </div>
                <div class="col">
            ...
            <div class="form-group row col-md-10 col-md-offset-1">
                <div class="col-sm-2 label_left" >
                    <label style="color: #102958;" ><small><font color="red">*</font></small>Position:</label>
                </div>
                <div class="col">
            ...
            <div class="form-group row col-md-10 col-md-offset-1">
                <div class="col-sm-2 label_left" >
                    <label style="color: #102958;" ><small><font color="red">*</font></small>Department:</label>
                </div>
...
.caret {
    ...
    border-left: 2px soild transparent !important;
}
</style>
