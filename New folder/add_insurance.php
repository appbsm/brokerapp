...
<script type="text/javascript">
    ...
    body_add +='</'+'script>';
      ...
      body_add +='<script type="text/javascript">';
        ...
        body_add +='    <div class="form-group row mb-20 col-md-10 col-md-offset-1">';
        body_add +='        <div class="col-sm-2  label_left" >';
        body_add +='            <label style="color: #102958;" for="staticEmail" ><small><font color="red">*</font></small>InsuranceInsurance Company:</label>';
        body_add +='        </div>';
        body_add +='        <div class="col"  >';
        ...
        body_add +='        </div>';
        body_add +='        <div class="col">';
        body_add +='<input type="text" id="currency'+input_value+'" name="currency[]" style="border-color:#102958;" class="form-control" value="'+item.currency_name+'" readOnly/>';
        body_add +='       </div>';
        body_add +='    </div>';
...
////////////////////////////////-----------------คำนวณวัน end------------------//////////////////////////////
        ...
        body_add +='        </div> ';
        body_add +='        <div class="col">';
        body_add +='            <input id="start_date'+input_value+'" name="start_date[]" style="color: #0C1830;border-color:#102958;" type="text"  class="form-control" value="'+item.start_date_f+'" placeholder="dd-mm-yyyy" required>';
        body_add +='        </div>';
        body_add +='        <div class="col-sm-2 label_right" >';
        body_add +='            <label style="color: #102958;" for="staticEmail" ><small><font color="red">*</font></small>End date:</label>';
        body_add +='        </div> ';
        body_add +='        <div class="col">';
        body_add +='            <input id="end_date'+input_value+'" name="end_date[]" style="color: #0C1830;border-color:#102958;" type="text" name="name"  class="form-control" id="success" value="'+item.end_date_f+'" placeholder="dd-mm-yyyy" required>';
        body_add +='        </div>';
        body_add +='    </div>';
        ...
        body_add +='        </div> ';
        body_add +='         <div class="col-sm-2">';
        body_add +='            <input id="paid_date'+input_value+'" name="paid_date[]"  style="color: #0C1830;border-color:#102958;" type="text"  class="form-control" ';
    ...
    body_add +='            </div> ';
    body_add +='            <div class="col-sm-4">';
    body_add +='                <input id="start_date_popup'+input_value+'"  required="required" style="color: #0C1830;border-color:#102958;" type="text" class="form-control" ';
    ...
    body_add +='            </div> ';
    body_add +='            <div class="col-sm-4">';
    body_add +='                <input id="end_date_popup'+input_value+'"  required="required" style="color: #0C1830;border-color:#102958;" type="text"  class="form-control" ';
    body_add +='                value="<?php echo $start_date; ?>" placeholder="dd-mm-yyyy" >';
    body_add +='            </div>';
    body_add +='        </div>';
    ...
    //Start premium----------------------------------------------------------------------------------------------
        ...
        body_add +='        </div> ';
        body_add +='         <div class="col-sm-2">';
        body_add +='            <input id="paid_date_pop'+input_value+'" style="color: #0C1830;border-color:#102958;" type="text"  class="form-control" ';
...
<script >
    ...
    $('#add').click(function() {
        ...
        body_add +='    <div class="form-group row mb-20 col-md-10 col-md-offset-1">';
        body_add +='        <div class="col-sm-2  label_left" >';
        body_add +='            <label style="color: #102958;" for="staticEmail" ><small><font color="red">*</font></small>Insurance Company:</label>';
        body_add +='        </div>';
        body_add +='        <div class="col"  >';
        ...
        body_add +='        </div>';
        body_add +='        <div class="col">';
        body_add +='<input type="text" id="currency'+input_value+'" name="currency[]" style="border-color:#102958;" class="form-control" value="<?php echo $currency_name; ?>" readOnly/>';
        body_add +='       </div>';
        body_add +='    </div>';
...
body_add +='</'+'script>';
        ...
        body_add +='        </div> ';
        body_add +='        <div class="col">';
        body_add +='            <input id="start_date'+input_value+'" name="start_date[]" style="color: #0C1830;border-color:#102958;" type="text"  class="form-control" value="<?php echo $start_date; ?>" placeholder="dd-mm-yyyy" required>';
        body_add +='        </div>';
        body_add +='        <div class="col-sm-2 label_right" >';
        body_add +='            <label style="color: #102958;" for="staticEmail" ><small><font color="red">*</font></small>End date:</label>';
        body_add +='        </div> ';
        body_add +='        <div class="col">';
        body_add +='            <input id="end_date'+input_value+'" name="end_date[]" style="color: #0C1830;border-color:#102958;" type="text" name="name"  class="form-control" id="success" value="<?php echo $start_date; ?>" placeholder="dd-mm-yyyy" required>';
        body_add +='        </div>';
        body_add +='    </div>';
