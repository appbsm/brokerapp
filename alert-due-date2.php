                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="row pull-right">
                            ...
                            <div class="text-right">
                                ...
                                <a href="#" class="btn btn-primary" style="color:#F9FAFA;" >
...
?>
                                ...
                                <table id="example"  class="table table-bordered "  style="color: #969FA7;" width="100%" >
                                    <thead >
                                        <tr style="color: #102958;" >
                                            ...
                                            <th class="text-center" style="color: #102958;">Status</th>
                                            <th class="text-center"  style="color: #102958;">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody style="color: #0C1830;" >
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="edit-policy.php?id=1"><i class="fa " title="Edit Record"></i>
 <svg width="20" height="20" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
  <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001m-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708z"/>
                                                 ...
                                                 <a href="entry-policy.php?id=1" onclick="return confirm('Do you really want to delete the notice?');">
