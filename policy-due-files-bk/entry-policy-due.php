...
$sql="delete from rela_customer_to_insurance where id_default_insurance=:id";
$query = $dbh->prepare($sql);
$query->bindParam(':id',$id,PDO::PARAM_STR);
$query->execute();
...
$sql = " SELECT ip.insurance_company AS insurance_company_in,pr.product_name AS product_name_in,cu.tel AS tel_customer,cu.email AS email_customer,insu.status AS status_insurance 
     ...
     ,FORMAT(end_date, 'yyyy-MM-dd') AS end_date_day,insu.* 
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                             <div class="panel-title"  >
                                <h2 class="title" style="color: #102958;">Due Policy</h2>
                            </div>
...
?> 
    <tr>
        ...
        <?php if($result->customer_type=="Corporate"){ ?>
        <td><?php echo $result->company_name;?></td>
        <?php }else{ ?>
        <td><?php echo $result->title_name_customer." ".$result->first_name_customer." ".$result->last_name_customer; ?></td>
        <?php } ?>

        <td><?php echo $result->tel_customer;?></td>
        <td><?php echo $result->email_customer;?></td>
        <!-- <td><?php //echo date('Y-m-d',$result->start_date);?></td> -->
        <td><?php echo $result->start_date_day;?></td>
        <td><?php echo $result->end_date_day;?></td>
