<?php
	...
	$sql = "SELECT * from customer_level where level_name='".$level_name."' and id!=:id";   
	...
	//      $active=0;
	// }
	// $sql="update customer_level set level_name=:level_name_p,status=:status_p,modify_by=GETDATE(),modify_by=:modify_by_p where id=:id";
	$sql="update customer_level set level_name=:level_name_p,description=:description_p,status=:status_p,udate=GETDATE(),modify_by=:modify_by_p where id=:id";
	// echo '<script>alert("sql: '.$sql.'")</script>'; 
	// echo "sql:".$sql;
	$query = $dbh->prepare($sql); 
	$query->bindParam(':level_name_p',$level_name,PDO::PARAM_STR);
	...
	// }
		...
		$error="This customer Level already exit";
	}
	...
	if($_GET['id']){
		$sql_user = " SELECT * from customer_level WHERE id=".$_GET['id'];
    ...
    <div class="row breadcrumb-div" style="background-color:#ffffff">
        <div class="col-md-6" >
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="customer_level.php">Customer Level</a></li>
                <li class="active">Edit Customer Level</li
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="form-group row col-md-10 col-md-offset-1">
                        <div class="col">
                            <div class="panel-title" style="color: #102958;" >
                                <h2 class="title">Edit Customer Level</h2>
                            </div>
                        </div>
                        <div class="col-sm-2 ">
                        </div>
