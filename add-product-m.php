...
<div class="container-fluid">
        ...
        <div class="panel-body">
            <div class="form-group row">
                 <label style="color: #102958;" for="staticEmail" class="col-sm-2 col-form-label">Product Categories:</label>
                <div class="col-sm-4">
                ...
                <label style="color: #102958;" for="staticEmail" class="col-sm-2 col-form-label">Product Sub Categories:</label>
                <div class="col-sm-4">
                <select name="id_role" style="color:#0C1830;border-color:#102958;" class="form-control" id="default" value="">
            ...
            <div class="form-group row">
                <label style="color: #102958;" for="staticEmail" class="col-sm-2 col-form-label">Product Note:</label>
                <div class="col-sm-4">
                    <input minlength="1" maxlength="50" style="color: #0C1830;border-color:#102958;" type="text" name="name" required="required" class="form-control" id="success" value="" >
