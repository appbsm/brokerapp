                                ...
                                <table id="example"  class="table table-bordered "  style="color: #969FA7;" >
                                    <thead >
                                        <tr style="color: #102958;" >
                                            <th width="20px" style="background-color: #ffffff !important;" style="color: #102958;" class="freeze-col" >
                                                <input type="checkbox" id="select-all">
                                            </th>
                                            <th width="20px" style="background-color: #ffffff !important;" style="color: #102958;" class="freeze-col">#</th>
                                            <th width="150px" style="background-color: #ffffff !important;" style="color: #102958;" class="freeze-col">Policy no.</th>
                                            <th hidden="tue" >ID</th>
