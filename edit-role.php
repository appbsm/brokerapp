<?php
	...
	if(isset($_POST['submit']) ){
		...
		$sql = "update role_name set status=".$role_status.",role_name='".$role_name."' where id=".$_GET['id'];
		// echo '<script>alert("last sql: '.$sql .'")</script>';
		$query = $dbh->prepare($sql); 
		$query->execute();
	...
	if($_GET['id'] != ""){
		$sql_table = "SELECT rn.id,rn.role_name,rn.status,ur.id,ur.page_view ".
		...
		" WHERE ur.status = 1 AND rn.id = ".$_GET['id']." ORDER BY ap.sort asc";
		// echo $sql_table;
			...
			<div class="row breadcrumb-div" style="background-color:#ffffff">
				<div class="col-md-12" >
					<ul class="breadcrumb">
						...
						<li class="active"  ><a href="manage-role.php">View Role</a></li>
				...
				<div class="panel">
					<div class="panel-body">
						<div class="form-group row col-md-10 col-md-offset-1" >
							...
							<!-- col-xs-auto -->
							<div class="col ">
								<input id="role_name" name="role_name" value="<?php echo $role_name; ?>" minlength="1" maxlength="25" style="color: #0C1830;border-color:#102958;" type="text" required="required" class="form-control input_text"  >
							</div>
               
							<div class="col-sm-2 label_right" >
								<input id="role_status" name="role_status"  class="form-check-input" type="checkbox" value="true" 
								<?php if($active==1){ ?>
									checked
								<?php } ?>
								>
