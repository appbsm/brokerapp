...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!empty($_POST)) {
        $customers = get_customers_contact_search($conn,$_POST);

        $customer = $_POST['customer'];
        $status = $_POST['status'];
    }
}else{
    $customers = get_customers_contact_search_start($conn);
}
                            ...
                            <div class="row breadcrumb-div" style="background-color:#ffffff">
                                <div class="col-md-6" >
                                    <ul class="breadcrumb">
                                        ...
                                        <!-- <li> Classes</li> -->
                                        <li class="active" >Report Customer Contact</li>
                                    </ul>
                                </div>
                            </div>
        </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header">
                             ...
                             <div class="panel-title" >
                                <h2 class="title m-5" style="color: #102958;">Report: Customer Contact
                            </div>  
                        </div>


<form method="post" action = "report-customer_contact.php" >
...
<div class="row pull-right">                    
                                ...
                                <table class="table table-bordered" id="example"  cellspacing="0">
                                    ...
                                    <tbody style="font-size: 13px;">
										...
										<tr>
                                            ...
                                            <?php if($c['customer_id']!=$customer_id){ ?>
                                                <td class="text-center"><?php echo $ctr;?></td>
                                                <td><?php echo $c['customer_id']; $customer_id=$c['customer_id']; ?></td>
    ...
    var table = $('#example').DataTable({
        ...
        // "paging":         true,
        buttons: [
            { extend: 'csv',class: 'buttons-csv',className: 'btn-primary',charset: 'UTF-8',filename: 'Report customer contact',bom: true
            ,init : function(api,node,config){ $(node).hide();} },
            { extend: 'excel',class: 'buttons-excel', className: 'btn-primary',charset: 'UTF-8',filename: 'Report customer contact',bom: true 
            ,init : function(api,node,config){ $(node).hide();} },
            { extend: 'pdf',class: 'buttons-pdf',className: 'btn-primary',charset: 'UTF-8',filename: 'Report customer contact',bom: true 
