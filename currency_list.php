...
<?php
	...
	if($_GET['id']){
		$sql = "SELECT TOP 1 * from insurance_partner WHERE id_currency_list = '".$_GET['id']."'"; 
		$query = $dbh->prepare($sql);
		$query->execute();
		$results_insurance = $query->fetchAll(PDO::FETCH_OBJ);

		if(count($results_insurance)==0){
			$sql="delete from currency_list where id=:id";
			$query = $dbh->prepare($sql);
	...
	$sql_check = "SELECT * from currency_list where currency='".$currency."'";   
	...
	$sql="INSERT INTO currency_list (currency,description,status,cdate,create_by)
	...
	$sql = "SELECT * from currency_list where currency=".$period." and id!=:id";   
	$query = $dbh->prepare($sql);
	$query->execute();
			...
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<div class="panel-title" style="display: inline-block;">
						<h2 class="title m-5" style="color: #102958;">Currency List</h2>
					</div>
					<div class="row pull-right" style="display: inline-block;">
						<div class="text-right m-5">
							<div class="row">
								...
								<?php if($status_add==1){ ?>
								<a href="add-currency_list.php" class="btn btn-primary" style="color:#F9FAFA;" >
            ...
            <div class="form-group row col-md-10 col-md-offset-1">
                        <div class="col">
                            <div class="panel-title" style="color: #102958;" >
                                <h2  style="color: #102958;" class="title">Add Currency List</h2>
                            </div>
                        </div>
                        <div class="col-sm-2 ">
                        </div>
        ...
        <div class="panel-body">
                <div class="form-group row col-md-10 col-md-offset-1" >
                    <div class="col-sm-2  label_left" >
                        <label style="color: #102958;" for="success" class="control-label">Currency Code</label>
                    </div> 
                    <div class="col ">
...
<div id="area_edit" hidden="true"  >
        <div class="panel-heading">
            <div class="form-group row col-md-10 col-md-offset-1">
                        <div class="col">
                            <div class="panel-title" style="color: #102958;" >
                                <h2 style="color: #102958;" class="title">Edit Currency List</h2>
                            </div>
                        </div>
                        <div class="col-sm-2 ">
                        </div>
...
<!------------------------------------------------------------------------------->
                ...
                <tr>
                    ...
                    <td class="text-center" class="currency_table" ><?php echo $result->currency;?></td>
...
<?php //if($status_edit==1){ ?>
<a href="edit-currency_list.php?id=<?php echo $result->id; ?>"><i class="fa " title="Edit Record"></i>
...
<?php //} ?>
    ...
    <a href="currency_list.php?id=<?php echo $result->id; ?>" onclick="return confirm('Do you really want to delete data?');">
...
<link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.10.0/css/bootstrap-select.min.css" rel="stylesheet" />
    ...
    var table = $('#example').DataTable({
        ...
        "paging":         true,
        buttons: [
            { extend: 'csv',class: 'buttons-csv',className: 'btn-primary',charset: 'UTF-8',filename: 'Currency List',bom: true
            ,exportOptions: {columns: ':not(:last-child)'},init : function(api,node,config){ $(node).hide();} },
            { extend: 'excel',class: 'buttons-excel', className: 'btn-primary',charset: 'UTF-8',filename: 'Currency List',bom: true 
            ,exportOptions: {columns: ':not(:last-child)'},init : function(api,node,config){ $(node).hide();} },
            { extend: 'pdf',class: 'buttons-pdf',className: 'btn-primary',charset: 'UTF-8',filename: 'Currency List',bom: true 
            ,exportOptions: {columns: ':not(:last-child)'},init : function(api,node,config){ $(node).hide();} },
