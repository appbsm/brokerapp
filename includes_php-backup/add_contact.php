<script>
    ...
    var input_contact = ["first_co","mobile_co","last_co","tel_co","nick_co"
        ,"email_co","position_co","line_co","remark_co"];
...
// $(document).ready(function() {
    ...
    var input_contact = ["first_co","mobile_co","last_co","tel_co","nick_co"
        ...
        if(value=="false"){
            ...
            document.getElementById('remark_co').readOnly = true;
                        ...
                        // alert('No Information Contact Person for Customer');
            ...
            for (var i = 0; i < input_contact.length; i++){
                document.getElementById(input_contact[i]).readOnly = false;
            }
            ...
            for (var i = 0; i < input_contact.length; i++){
                document.getElementById(input_contact[i]).readOnly = false;
                document.getElementById(input_contact[i]).value = "";
            }
     ...
     function same_contact(item) {
        ...
        body_add +='        </div>';
        body_add +='        <div class="col">';
        body_add +='            <select id="title_co" name="title_co[]" style="color: #4590B8;border-color:#102958;" class="form-control" disabled="true">';
        ...
        body_add +='            <input id="remark_co" name="remark_co[]" value="'+item.remark+'" minlength="1" maxlength="50" style="color: #0C1830;border-color:#102958;" type="text" class="form-control" disabled="true" >';
        body_add +='        </div>';
        body_add +='        <div class="col-sm-6 label_right" >';
    ...
    $('#add-con').click(function() {
        ...
        body_add +='        </div>';
        body_add +='        <div class="col">';
        body_add +='            <input id="mobile_co" name="mobile_co[]" minlength="1" maxlength="50" style="color: #0C1830;border-color:#102958;" type="text" class="form-control"  >';
        body_add +='        </div>';
        body_add +='    </div>';
        body_add +='    <div class="form-group row col-md-10 col-md-offset-1">';
        body_add +='        <div class="col-sm-2 label_left" >';
        ...
        body_add +='        </div>';
        body_add +='        <div class="col">';
        body_add +='            <input id="last_co" name="last_co[]" minlength="1" maxlength="50" style="color: #0C1830;border-color:#102958;" type="text" class="form-control"  >';
        body_add +='        </div>';
        body_add +='        <div class="col-sm-2 label_right" >';
        body_add +='            <label style="color: #102958;" >Tel:</label>';
        body_add +='        </div>  ';
        ...
        body_add +='        </div>';
        body_add +='        <div class="col">';
        body_add +='            <input id="email_co" name="email_co[]" minlength="1" maxlength="50" style="color: #0C1830;border-color:#102958;" type="text" class="form-control"  >';
        body_add +='       </div>';
        body_add +='    </div>';
        body_add +='    <div class="form-group row col-md-10 col-md-offset-1">';
        body_add +='       <div class="col-sm-2 label_left" >';
        ...
        body_add +='        </div>';
        body_add +='        <div class="col">';
        body_add +='            <input id="position_co" name="position_co[]" minlength="1" maxlength="50" style="color: #0C1830;border-color:#102958;" type="text" class="form-control"  >';
        body_add +='        </div>';
        body_add +='        <div class="col-sm-2 label_right" >';
        body_add +='            <label style="color: #102958;" >Line ID:</label>';
        body_add +='        </div>';
    ...
    if(province!=""){
        $.get('get_province_id.php?code_id=' + province, function(data){
            ...
            $.each(result, function(index, item){
                ...
                // alert('item.name_th:'+item.name_th);
            });
            $("#province").selectpicker('refresh');
        });
    }else{
    ...
    if(district!=""){
        $.get('get_district_id.php?code_id=' + district, function(data){
            var result = JSON.parse(data);
            $.each(result, function(index, item){
                districtObject.html('<option value="'+item.code+'">'+item.name_th+'</option>')
            });
            $("#district").selectpicker('refresh');
        });
    }else{
    ...
    if(sub_district!=""){
        $.get('get_sub_district_id.php?code_id=' + sub_district, function(data){
            var result = JSON.parse(data);
            $.each(result, function(index, item){
                sub_districtObject.html('<option value="'+item.code+'">'+item.name_th+'</option>')
            });
            $("#sub_district").selectpicker('refresh');
        });
    }else{
    ...
    if(postcode!=""){
        ...
        $("#postcode").selectpicker('refresh');
        // $.get('get_postcode_id.php?code_id=' + postcode, function(data){
        //     var result = JSON.parse(data);
        //     $.each(result, function(index, item){
        ...
        var value = document.getElementById("same_co").value;
        // alert('cb:'+cb.value);
            // var customer_id = document.getElementById("same_co").value;
